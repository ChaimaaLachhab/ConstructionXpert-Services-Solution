    ...
    <div class="container">
        ...
        <form id="taskForm" enctype="multipart/form-data">
            <section class="container flex-column col-md-6 col-sm-11 mt-5" style="background-color: rgba(133, 132, 132, 0.2); width: 55%; padding: 30px; border-radius: 20px; box-shadow: 5px 5px 20px rgb(0, 0, 0, 0.5);">
                <input class="form-control mb-4" type="hidden"  id="projectId" value="${projectId}">
                <div>
                    <h4>Task Name:</h4>
                    <input class="form-control mb-4" type="text" placeholder="Enter Name" id="taskName" name="taskName">
                </div>
                <div class="mb-4">
                    <h4>Status:</h4>
                ...
                <div class="mb-4">
                    <h4>Task Image:</h4>
                    <input class="form-control mb-4" type="text" placeholder="Enter Name" id="taskImg" name="taskImg">
                </div>
                <div class="mb-4">
                    <h4>Description:</h4>
                    <div class="form-floating">
                        <textarea class="form-control" placeholder="Leave a comment here" id="taskDescription" name="taskDescription" style="height: 100px"></textarea>
                    </div>
                </div>
                <div class="mb-4">
                    <h4>Start Date:</h4>
                    <input type="date" class="form-control" id="taskStartDate" name="taskStartDate">
                </div>
                <div class="mb-4">
                    <h4>End Date:</h4>
                    <input type="date" class="form-control" id="taskEndDate" name="taskEndDate">
                </div>
                <button type="submit" class="btn globalBgColor ms-3">Add Task</button>
            </section>
        </form>
        ...
        <script>
            async function sendTask(event) {
                ...
                try {
                    const response = await fetch(`${pageContext.request.contextPath}/AddTaskServlet`, {
                        method: 'POST',
                        headers: {
