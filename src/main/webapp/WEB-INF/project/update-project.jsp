    ...
    <div class="container">
        ...
        <form id="projectForm" enctype="multipart/form-data">
            <section class="container flex-column col-md-6 col-sm-11 mt-5" style="background-color: rgba(133, 132, 132, 0.2); width: 55%; padding: 30px; border-radius: 20px; box-shadow: 5px 5px 20px rgb(0, 0, 0, 0.5);">
                <input class="form-control mb-4" type="hidden" placeholder="Enter Name" id="projectId" name="projectId" value="${project.projectId}">
                <div>
                    <h4>Project Name:</h4>
                    <input class="form-control mb-4" type="text" placeholder="Enter Name" id="projectName" name="projectName" value="${project.projectName}">
                </div>
                <div class="mb-4">
                    <h4>Type:</h4>
                ...
                <div class="mb-4">
                    <h4>Project Image:</h4>
                    <input class="form-control mb-4" type="text" placeholder="Enter Name" id="projectImg" name="projectImg" value="${project.projectImg}">
                </div>
                <div class="mb-4">
                    <h4>Description:</h4>
                    <div class="form-floating">
                        <textarea class="form-control" placeholder="Leave a comment here" id="description" name="description" style="height: 100px" >${project.description}</textarea>
                    </div>
                </div>
                <div class="mb-4">
                    <h4>Start Date:</h4>
                ...
                <div class="mb-4">
                    <h4>Budget:</h4>
                    <input type="number" class="form-control" id="budget" name="budget" step="0.01" placeholder="Enter Budget" value="${project.budget}">
                </div>
        ...
        <script>
            async function sendData(event) {
                ...
                try {
                    const response = await fetch(`${pageContext.request.contextPath}/UpdateProjectServlet`, {
                        method: 'POST',
                        headers: {
